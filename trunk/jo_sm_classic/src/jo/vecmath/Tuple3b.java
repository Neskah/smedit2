...
public abstract class Tuple3b implements java.io.Serializable, Cloneable {
    ...
    /**
     * Places the value of the x,y,z components of this Tuple3b into the array
     * of length 3.
     *
     ...
     * different Tuple3b objects with identical data values (i.e.,
     * Tuple3b.equals returns true) will return the same hash code value. Two
