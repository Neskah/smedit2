...
public class Color4f extends Tuple4f implements java.io.Serializable {
     ...
     *
     * @since vecmath 1.2 public Color4f(Color color) {
     * super((float)color.getRed() / 255.0f, (float)color.getGreen() / 255.0f,
     ...
     * (float)color.getRed() / 255.0f; y = (float)color.getGreen() / 255.0f; z =
     * (float)color.getBlue() / 255.0f; w = (float)color.getAlpha() / 255.0f; }
     */
    /**
     ...
     *
     * @since vecmath 1.2 public final Color get() { int r = Math.round(x *
     * 255.0f); int g = Math.round(y * 255.0f); int b = Math.round(z * 255.0f);
