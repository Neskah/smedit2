 ...
 * @since vecmath 1.2
 */
public abstract class Tuple3s implements java.io.Serializable, Cloneable {
     ...
     */
    public Tuple3s(short x, short y, short z) {
        this.x = x;
        this.y = y;
        this.z = z;
    }
     ...
     * @param z the z coordinate
     */
    public final void set(short x, short y, short z) {
        this.x = x;
        this.y = y;
        this.z = z;
    }
     ...
     */
    public final void set(Tuple3s t1) {
        this.x = t1.x;
        this.y = t1.y;
        this.z = t1.z;
    }
     ...
     */
    public final void get(Tuple3s t) {
        t.x = this.x;
        t.y = this.y;
        t.z = this.z;
    }
     ...
     */
    public final void add(Tuple3s t1, Tuple3s t2) {
        this.x = (short) (t1.x + t2.x);
        this.y = (short) (t1.y + t2.y);
        this.z = (short) (t1.z + t2.z);
    }
     ...
     */
    public final void add(Tuple3s t1) {
        this.x += t1.x;
        this.y += t1.y;
        this.z += t1.z;
    }
     ...
     * @param t2 the second tuple
     */
    public final void sub(Tuple3s t1, Tuple3s t2) {
        this.x = (short) (t1.x - t2.x);
        this.y = (short) (t1.y - t2.y);
        this.z = (short) (t1.z - t2.z);
    }
     ...
     * @param t1 the other tuple
     */
    public final void sub(Tuple3s t1) {
        this.x -= t1.x;
        this.y -= t1.y;
        this.z -= t1.z;
    }
     ...
     */
    public final void negate(Tuple3s t1) {
        this.x = (short) -t1.x;
        this.y = (short) -t1.y;
        this.z = (short) -t1.z;
    }
     ...
     * @param t1 the source tuple
     */
    public final void scale(short s, Tuple3s t1) {
        this.x = (short) (s * t1.x);
        this.y = (short) (s * t1.y);
        this.z = (short) (s * t1.z);
    }
     ...
     */
    public final void scaleAdd(short s, Tuple3s t1, Tuple3s t2) {
        this.x = (short) (s * t1.x + t2.x);
        this.y = (short) (s * t1.y + t2.y);
        this.z = (short) (s * t1.z + t2.z);
    }
     ...
     */
    public final void scaleAdd(short s, Tuple3s t1) {
        this.x = (short) (s * this.x + t1.x);
        this.y = (short) (s * this.y + t1.y);
        this.z = (short) (s * this.z + t1.z);
    }
     ...
     */
    public final void clamp(short min, short max, Tuple3s t) {
        if (t.x > max) {
            x = max;
        } else if (t.x < min) {
            x = min;
     ...
     * @param t the source tuple, which will not be modified
     */
    public final void clampMin(short min, Tuple3s t) {
        if (t.x < min) {
            x = min;
        } else {
            x = t.x;
     ...
     * @param t the source tuple, which will not be modified
     */
    public final void clampMax(short max, Tuple3s t) {
        if (t.x > max) {
            x = max;
        } else {
            x = t.x;
     ...
     * @param t the source tuple, which will not be modified
     */
    public final void absolute(Tuple3s t) {
        x = (short) Math.abs(t.x);
        y = (short) Math.abs(t.y);
        z = (short) Math.abs(t.z);
    }
     ...
     */
    public final void clamp(short min, short max) {
        if (x > max) {
            x = max;
        } else if (x < min) {
            x = min;
     ...
     * @param min the lowest value in this tuple after clamping
     */
    public final void clampMin(short min) {
        if (x < min) {
            x = min;
        }
     ...
     * @param max the highest value in the tuple after clamping
     */
    public final void clampMax(short max) {
        if (x > max) {
            x = max;
        }
     ...
     * @since vecmath 1.5
     */
    public final void setZ(short z) {
        this.z = z;
    }
}
