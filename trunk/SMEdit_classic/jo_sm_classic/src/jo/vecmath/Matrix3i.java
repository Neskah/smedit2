 ...
 *
 */
public class Matrix3i implements java.io.Serializable, Cloneable {
     ...
     */
    public Matrix3i(int m00, int m01, int m02,
    ...
    public final void setScale(int scale) {
        ...
        this.m00 = (int) (tmp_rot[0] * scale);
        this.m01 = (int) (tmp_rot[1] * scale);
        this.m02 = (int) (tmp_rot[2] * scale);

        this.m10 = (int) (tmp_rot[3] * scale);
        this.m11 = (int) (tmp_rot[4] * scale);
        this.m12 = (int) (tmp_rot[5] * scale);

        this.m20 = (int) (tmp_rot[6] * scale);
        this.m21 = (int) (tmp_rot[7] * scale);
        this.m22 = (int) (tmp_rot[8] * scale);
     ...
     */
    public final void setRow(int row, int x, int y, int z) {
        switch (row) {
            case 0:
                this.m00 = x;
                this.m01 = y;
     ...
     */
    public final void setRow(int row, Point3i v) {
        switch (row) {
            case 0:
                this.m00 = v.x;
                this.m01 = v.y;
     ...
     */
    public final void setColumn(int column, int x, int y, int z) {
        switch (column) {
            case 0:
                this.m00 = x;
                this.m10 = y;
     ...
     */
    public final void setColumn(int column, Point3i v) {
        switch (column) {
            case 0:
                this.m00 = v.x;
                this.m10 = v.y;
     ...
     */
    public final void add(int scalar, Matrix3i m1) {
     ...
     */
    public final void add(Matrix3i m1, Matrix3i m2) {
     ...
     */
    public final void add(Matrix3i m1) {
        this.m00 += m1.m00;
        this.m01 += m1.m01;
        this.m02 += m1.m02;
     ...
     * @param m2 the second matrix
     */
    public final void sub(Matrix3i m1, Matrix3i m2) {
        this.m00 = m1.m00 - m2.m00;
        this.m01 = m1.m01 - m2.m01;
        this.m02 = m1.m02 - m2.m02;
     ...
     * @param m1 the other matrix
     */
    public final void sub(Matrix3i m1) {
        this.m00 -= m1.m00;
        this.m01 -= m1.m01;
        this.m02 -= m1.m02;
     ...
     */
    public final void transpose(Matrix3i m1) {
        if (this != m1) {
            this.m00 = m1.m00;
            this.m01 = m1.m10;
            this.m02 = m1.m20;
    ...
    public final void set(AxisAngle4d a1) {
        ...
        if (mag < EPS) {
            ...
            m00 = (int) (t * ax * ax + cosTheta);
            m01 = (int) (t * xy - sinTheta * az);
            m02 = (int) (t * xz + sinTheta * ay);

            m10 = (int) (t * xy + sinTheta * az);
            m11 = (int) (t * ay * ay + cosTheta);
            m12 = (int) (t * yz - sinTheta * ax);

            m20 = (int) (t * xz - sinTheta * ay);
            m21 = (int) (t * yz + sinTheta * ax);
            m22 = (int) (t * az * az + cosTheta);
        }
    ...
    /**
     * Sets the value of this matrix to the int value of the Matrix3d argument.
     *
     ...
     */
    public final void invert(Matrix3i m1) {
        invertGeneral(m1);
    }
     ...
     */
    private final void invertGeneral(Matrix3i m1) {
      ...
      //int c, r;
        ...
        this.m10 = (int) result[3];
        this.m11 = (int) result[4];
        this.m12 = (int) result[5];

        this.m20 = (int) result[6];
        this.m21 = (int) result[7];
        this.m22 = (int) result[8];
    ...
    public final void rotX(int angle) {
        ...
        sinAngle = (int) Math.sin((double) angle);
        cosAngle = (int) Math.cos((double) angle);
     ...
     */
    public final void rotZ(int angle) {
        int sinAngle, cosAngle;
     ...
     */
    public final void mul(int scalar, Matrix3i m1) {
     ...
     * @param m1 the other matrix
     */
    public final void mul(Matrix3i m1) {
        int m00, m01, m02,
                m10, m11, m12,
                m20, m21, m22;
     ...
     * @param m2 the second matrix
     */
    public final void mul(Matrix3i m1, Matrix3i m2) {
        if (this != m1 && this != m2) {
     ...
     */
    public final void mulNormalize(Matrix3i m1) {
        ...
        this.m00 = (int) (tmp_rot[0]);
        this.m01 = (int) (tmp_rot[1]);
        this.m02 = (int) (tmp_rot[2]);

        this.m10 = (int) (tmp_rot[3]);
        this.m11 = (int) (tmp_rot[4]);
        this.m12 = (int) (tmp_rot[5]);

        this.m20 = (int) (tmp_rot[6]);
        this.m21 = (int) (tmp_rot[7]);
        this.m22 = (int) (tmp_rot[8]);
     ...
     */
    public final void mulNormalize(Matrix3i m1, Matrix3i m2) {
     ...
     * @param m2 the matrix on the right hand side of the multiplication
     */
    public final void mulTransposeBoth(Matrix3i m1, Matrix3i m2) {
        if (this != m1 && this != m2) {
     ...
     * @param m2 the matrix on the right hand side of the multiplication
     */
    public final void mulTransposeRight(Matrix3i m1, Matrix3i m2) {
        if (this != m1 && this != m2) {
     ...
     * @param m2 the matrix on the right hand side of the multiplication
     */
    public final void mulTransposeLeft(Matrix3i m1, Matrix3i m2) {
        if (this != m1 && this != m2) {
     ...
     */
    public final void normalize(Matrix3i m1) {
        double[] tmp = new double[9];  // scratch matrix
        double[] tmp_rot = new double[9];  // scratch matrix
        double[] tmp_scale = new double[3];  // scratch matrix
    ...
    public final void normalizeCP() {
        int mag = 1 / (int) Math.sqrt(m00 * m00 + m10 * m10 + m20 * m20);
        m00 = m00 * mag;
        m10 = m10 * mag;
        m20 = m20 * mag;

        mag = 1 / (int) Math.sqrt(m01 * m01 + m11 * m11 + m21 * m21);
        m01 = m01 * mag;
        m11 = m11 * mag;
        m21 = m21 * mag;
     ...
     */
    public final void normalizeCP(Matrix3i m1) {
        int mag = 1 / (int) Math.sqrt(m1.m00 * m1.m00 + m1.m10 * m1.m10 + m1.m20 * m1.m20);
        m00 = m1.m00 * mag;
        m10 = m1.m10 * mag;
        m20 = m1.m20 * mag;

        mag = 1 / (int) Math.sqrt(m1.m01 * m1.m01 + m1.m11 * m1.m11 + m1.m21 * m1.m21);
        m01 = m1.m01 * mag;
        m11 = m1.m11 * mag;
        m21 = m1.m21 * mag;
     ...
     */
    public boolean equals(Matrix3i m1) {
        try {
     ...
     */
    public boolean epsilonEquals(Matrix3i m1, int epsilon) {
        boolean status = true;
     ...
     * @param m1 the source matrix
     */
    public final void negate(Matrix3i m1) {
        this.m00 = -m1.m00;
        this.m01 = -m1.m01;
        this.m02 = -m1.m02;
     ...
     */
    public final void transform(Tuple3i t) {
        int x, y, z;
     ...
     */
    public final void transform(Tuple3i t, Tuple3i result) {
        int x, y;
        x = m00 * t.x + m01 * t.y + m02 * t.z;
        y = m10 * t.x + m11 * t.y + m12 * t.z;
