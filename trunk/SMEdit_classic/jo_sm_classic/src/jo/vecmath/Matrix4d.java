...
public class Matrix4d implements java.io.Serializable, Cloneable {
     ...
     * normalized rotational component; the values are placed into the Quat4d
     * parameter.
     *
    ...
    /**
     * Returns true if the Object t1 is of type Matrix4d and all of the data
     ...
     * different Matrix4d objects with identical data values (i.e.,
     * Matrix4d.equals returns true) will return the same hash code value. Two
     ...
     * into pointOut. The fourth element of the point input parameter is assumed
     * to be one.
     *
