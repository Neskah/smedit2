...
public class VolcanoParametersBeanInfo implements BeanInfo {

    private final BeanInfo mRootBeanInfo;

    public VolcanoParametersBeanInfo() throws IntrospectionException {
        super();
        mRootBeanInfo = Introspector.getBeanInfo(VolcanoParameters.class, Introspector.IGNORE_IMMEDIATE_BEANINFO);
    }
