...
public abstract class Tuple2i implements java.io.Serializable, Cloneable {
     ...
     *
     * @param t1 the Tuple2i containing the initialization x and y data.
     */
     ...
     * different Tuple2i objects with identical data values (i.e.,
     * Tuple2i.equals returns true) will return the same hash code value. Two
