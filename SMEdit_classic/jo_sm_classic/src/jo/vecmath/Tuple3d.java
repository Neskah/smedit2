...
public abstract class Tuple3d implements java.io.Serializable, Cloneable {
    ...
    /**
     * Sets the value of this tuple to the value of the xyz coordinates located
     * in the array of length 3.
     *
     * @param t the array of length 3 containing xyz in order
     */
     ...
     *
     * @param t the Tuple3d object into which the values of this object are
     * copied
     */
     ...
     * different Tuple3d objects with identical data values (i.e.,
     * Tuple3d.equals returns true) will return the same hash code value. Two
    ...
    /**
     * Returns true if the Object t1 is of type Tuple3d and all of the data
