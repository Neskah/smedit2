...
public class ReplaceParametersBeanInfo implements BeanInfo {

    private final BeanInfo mRootBeanInfo;

    public ReplaceParametersBeanInfo() throws IntrospectionException {
        super();
        mRootBeanInfo = Introspector.getBeanInfo(ReplaceParameters.class, Introspector.IGNORE_IMMEDIATE_BEANINFO);
    }
